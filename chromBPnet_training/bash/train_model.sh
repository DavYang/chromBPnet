...
BAM_FILE="/gs/gsfs0/shared-lab/greally-lab/David/chromBPnet_analysis/nf-core_atac/results/bwa/merged_library/autosomes_only/merged_pbmcs_2-4/pbmc-2_4_merged.mLb.clN.sorted.bam"
...
PEAKS_FILE="/gs/gsfs0/shared-lab/greally-lab/David/chromBPnet_analysis/peak_calling/outputs/pbmc-2_4_merged/pbmc-2_4_merged_peaks.final.narrowPeak"
NEGATIVE_FILE="/gs/gsfs0/shared-lab/greally-lab/David/chromBPnet_analysis/generate_folds/outputs/pbmc-2_4_merged/folds/f${FOLD_ID}_output_negatives.bed"
FOLD_FILE="/gs/gsfs0/shared-lab/greally-lab/David/chromBPnet_analysis/generate_folds/outputs/pbmc-2_4_merged/splits/fold_${FOLD_ID}.json"
BIAS_MODEL="/gs/gsfs0/shared-lab/greally-lab/David/chromBPnet_analysis/bias_model_training/outputs/pbmc-2_4_merged/bias_model_f0_b0.6/models/pbmc-2_4_merged_bias.h5"

# Define output directory with array index
OUTPUT_DIR="$HOME_DIR/outputs/pbmc-2_4_merged/chrombpnet_model_b0.6/fold_${FOLD_ID}/"
