...
OUTPUT_DIR="/gs/gsfs0/shared-lab/greally-lab/David/chromBPnet_analysis/chromBPnet_training/outputs/pbmc-2_4_merged/chrombpnet_model_b0.6/extracted_scores/contribution_scores_bw/fold_${FOLD_ID}/"
...
echo "Starting chromBPnet contributionscore extraction..."
