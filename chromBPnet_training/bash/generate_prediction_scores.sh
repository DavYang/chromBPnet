...
OUTPUT_DIR="/gs/gsfs0/shared-lab/greally-lab/David/chromBPnet_analysis/chromBPnet_training/outputs/neutrophil_merged/chrombpnet_model_b1.0/prediction_scores_bw/fold_${FOLD_ID}/"
...
# Run the prediction scores command
echo "=========================================="
...
if [ $EXIT_STATUS -ne 0 ]; then
    echo "ERROR: chromBPnet pred_bw failed with exit status $EXIT_STATUS" >&2
    echo "Check the error log for details" >&2
    exit $EXIT_STATUS
fi

echo ""
echo "SUCCESS: Prediction scores generated successfully for fold $FOLD_ID"
echo ""
