...
3) pearatefk_calling: This directory is dedicated to running MACS3 to call ATAC-seq peaks, using settings from the ChromBPNet paper.
...
6) chromBPnet_training : This directory is dedicated to training the chromBPnet model with the Tn5 model. 
7) variant_scoring: Dedicated to scoring NCVs using trained chrombpnet models.
